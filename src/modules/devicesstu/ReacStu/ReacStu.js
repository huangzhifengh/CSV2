...
class Module extends Page {
  ...
  getConfig1 () {
    return {
      ...
      columns: [
        ...
        {title:'电池状态',name:'',parse:(value,data)=>{let show='正常';if(data.deviceStatu){if('0'==data.deviceStatu.batteryState){show='低'}}return show}},
  ...
  getConfig5 () {
    return {
      dataSource: new DataSource({transport:{read:'/api/devices/statu/list?subType=104105'}}),
      title: '声光报警',
      checkable: false,
      pagination: {show:true,pageSize:10},
      columns: [
